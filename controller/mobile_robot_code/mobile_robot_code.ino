...
//wifi stuff
const char* ssid     = "SchlossA"; // wifi network name
const char* password = "Master59"; // wifi network password

//const char* ssid     = "Razer_Phone"; // wifi network name
//const char* password = "Password123"; // wifi network password
